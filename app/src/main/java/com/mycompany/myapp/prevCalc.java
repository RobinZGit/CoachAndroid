...
//модуль предрасчета. содержит функцию генерации массива тренировки
...
//
	...
	public class prevCalc //extends Service
	{
		...
		public int onStartCommand(Intent intent, int flags, int startId)
		{
			...
			return 0;// START_STICKY;//! super.onStartCommand(intent, flags, startId);
		}

...
//
//сервис показа дел ("календарь", макроритмы)
public class macrorithmService extends Service
	{
		...
		public void onCreate()
		{
			...
			Toast.makeText(getApplicationContext(),
						   "Macroritm is started" , Toast.LENGTH_LONG).show();
		...
		public int onStartCommand(Intent intent, int flags, int startId)
		{
			...
			try
			{
				...
				startserv(false, intent.getIntExtra("CountOfAllIterations", -1), GlnDelayMs);
			}
			catch (Exception e)
			{}

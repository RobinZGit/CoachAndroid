...
public class coachUtility
{
	...
	//final String SET_AREPEAT = "arepeat";
	//final String SET_ADELAYSEC = "adeals100";

	protected String sAMetaRithm="";
	protected String sARithm="";
	protected String sADeals100="";
	protected int Gl_SelectedIndexInit = 0;
	//protected String sARepeat="1";
	//protected String sADelaySec="0";
...
//#####################################################	
	...
	/*
		...
		*/
		...
		{
			{{{"name","хоккей в арке"} ,{"id","хоккей_в_арке"} }},
		...
		{
			{{{"name","хоккей или фартлек на дороге"} ,{"id","фартлек1"} }},
			{{{"showInSpinner","0"} ,{"повторить,раз","1"},{"отсрочка старта,сек","5"} ,{"дата последнего выполнения",""} }},
			{{{"tags","универсальные"}}},
			{{{"parameters"}
					//,{"par999","float","наименование тренировки","универсальный случайный счетчик до 10 видов команд"}
		...
		{
			{{{"name","универсальный счетчик до 10 видов команд"} ,{"id","универсальная_настраиваемая_1"} }},
			{{{"showInSpinner","0"} ,{"повторить,раз","1"},{"отсрочка старта,сек","5"} ,{"дата последнего выполнения",""}}},
			{{{"tags","универсальные"}}},
			{{{"parameters"}
					//,{"par999","float","наименование тренировки","универсальный случайный счетчик до 10 видов команд"}
	    ...
	    {
			{{{"name","медленнаяая дыхательная (100/скорость)(220+ 120*sin(3.14*по-лноевремя(0)/780))/(2*3*60) "},{"id","медл_дых_ур1"}}},
			{{{"showInSpinner","0"} ,{"повторить,раз","1"},{"отсрочка старта,сек","5"} ,{"дата последнего выполнения",""} }},
			{{{"tags","дых#"}}},
			{{{"parameters"},{"par1","string","комментарий к тренировке",""}

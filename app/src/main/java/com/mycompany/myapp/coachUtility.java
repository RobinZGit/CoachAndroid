...
//#####################################################	
	...
	{  
		...
		//=========== легкая домашняя на дождь =====
	    {
			...
			{},{},{},{},{},{}, //резерв
			{    
    			{{"20","раз по"},{"2","сек с дисперсией"},{"0"},{"сказать","->28"}},     
	...
	{   //==  для дыхательных  ======
		...
		/*26*/{{{"name","счетчик роллерхокк корпус шайба"},{"id","счетчик_роллерхок"}}, {{ "ОБЩАЯ ФРАЗА",""},{ "СКАЗАТЬ:","1","С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"1","ДЛИТЕЛЬНОСТЬ (СЕК):","1"},{ "СКАЗАТЬ:","2" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"1","ДЛИТЕЛЬНОСТЬ (СЕК):","1" },{  "СКАЗАТЬ:","3" , "С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"1" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","1"},{  "СКАЗАТЬ:","4", "С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"1" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","1"}  }},//,{"5" ,"1"},{ "6" ,"1"} ,{ "7" ,"1"},{"8" ,"1"},{ "9" ,"1"} }},
		/*27*/{{{"name","счетчик роллерхокк  перебежка "},{"id","счетчик_роллерхок_перебежка"}}, {{ "ОБЩАЯ ФРАЗА",""},{  "СКАЗАТЬ:","" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"6" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","0"},{  "СКАЗАТЬ:","par3" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" , "par5" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","par4"}  }},//,{"5" ,"1"},{ "6" ,"1"} ,{ "7" ,"1"},{"8" ,"1"},{ "9" ,"1"} }},
		/*28*/{{{"name","легкая домашняя на дождь"},{"id","легкая_домашняя_на_дождь"}}, {{ "ОБЩАЯ ФРАЗА",""}
		            ,{  "СКАЗАТЬ:","Подпрыгнуть 2 раза" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"1" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","par1*2/100"}
		            ,{  "СКАЗАТЬ:","подтянуться 2 раза" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" , "1" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","par1*2/100"}  }},//,{"5" ,"1"},{ "6" ,"1"} ,{ "7" ,"1"},{"8" ,"1"},{ "9" ,"1"} }},

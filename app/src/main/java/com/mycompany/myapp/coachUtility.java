...
//#####################################################	
	...
	{  
		...
		//=========== счетчик для роллерхок =====
	    {
			...
			{{{"parameters"}
	                ...
	                ,{"par0","string","пропорция пустого движения (ни броска ни перебежки)","4"}
					...
					,{"par6","string","бросок (если не нужен - оставить пустое поле)","бросок"}
		...
		//=========== счетчик для роллерхок 2 =====
	    {
			...
			{{{"parameters"}
					...
					,{"par2","string","комментарий к тренировке",""}
					//,{"par3","string","1","1"}
					,{"par4","string","длительность интервала(сек)","2"}
					,{"par5","string","1","1"}
	...
	{   //==  для дыхательных  ======
		...
		/*27*/{{{"name","счетчик роллерхокк  перебежка "},{"id","счетчик_роллерхок_перебежка"}}, {{ "ОБЩАЯ ФРАЗА",""}
		        ,{  "СКАЗАТЬ:","" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"par0" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","0,01"}
				,{  "СКАЗАТЬ:","par3" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" , "par5" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","par4*(100/par1)"} 
				,{  "СКАЗАТЬ:","par6" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" , "par7" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","par61*(100/par1)"} 
					}},//,{"5" ,"1"},{ "6" ,"1"} ,{ "7" ,"1"},{"8" ,"1"},{ "9" ,"1"} }},
		/*28*/{{{"name","легкая домашняя на дождь"},{"id","легкая_домашняя_на_дождь"}}, {{ "ОБЩАЯ ФРАЗА",""}
		        ,{  "СКАЗАТЬ:","подпрыгнуть" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"2" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","2*(100/par1)"}
				,{  "СКАЗАТЬ:","подтянуться" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" , "1" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","2*(100/par1)"} 
				,{  "СКАЗАТЬ:","отжаться" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"2" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","2*(100/par1)"}
				,{  "СКАЗАТЬ:","левый пистолетик" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"1" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","2*(100/par1)"}
				,{  "СКАЗАТЬ:","правый пистолетик" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"1" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","2*(100/par1)"}
				,{  "СКАЗАТЬ:","книжка" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"2" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","2*(100/par1)"}
				,{  "СКАЗАТЬ:","встать на руки" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"2" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","2*(100/par1)"}
				,{  "СКАЗАТЬ:","курочка" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"2" ,"ДЛИТЕЛЬНОСТЬ (СЕК):","2*(100/par1)"}
			}},//,{"5" ,"1"},{ "6" ,"1"} ,{ "7" ,"1"},{"8" ,"1"},{ "9" ,"1"} }},
			
		/*29*/{{{"name","счетчик 1-N"},{"id","счетчик_1_N"}}, {{ "ОБЩАЯ ФРАЗА",""}
		        ,{ "СКАЗАТЬ:","par5" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"par500","ДЛИТЕЛЬНОСТЬ (СЕК):","1*(100/par1)" }
	            ,{ "СКАЗАТЬ:","par6" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"par600","ДЛИТЕЛЬНОСТЬ (СЕК):","1*(100/par1)" }
				,{ "СКАЗАТЬ:","par7" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"par700","ДЛИТЕЛЬНОСТЬ (СЕК):","1*(100/par1)" }
				,{ "СКАЗАТЬ:","par8" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"par800","ДЛИТЕЛЬНОСТЬ (СЕК):","1*(100/par1)" }
				,{ "СКАЗАТЬ:","par9" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"par900","ДЛИТЕЛЬНОСТЬ (СЕК):","1*(100/par1)" }
				//,{ "СКАЗАТЬ:","par10" ,"С ПРОПОРЦ. ВЕРОЯТНОСТЬЮ:" ,"par1000","ДЛИТЕЛЬНОСТЬ (СЕК):","1*(100/par1)" }
		    }},//,{"5" ,"1"},{ "6" ,"1"} ,{ "7" ,"1"},{"8" ,"1"},{ "9" ,"1"} }},

...
public class coachUtility
{
	...
	final String SET_AMETARITHM_FILE_NAME = "ametarithmanddeals_tmp30";
	final String SET_AMETARITHM_BCK1_FILE_NAME = "bck1_ametarithmanddeals_tmp30";
	//>>
...
//#####################################################	
	...
	{  
		...
		//===========хоккей =====
	    {
			...
			{},{},{},{},{},{},{}, //резерв
			{   
				{{"1","раз по"},{"5", "сек с дисперсией"},{"0"},{"текст дела","хоккей один период в две пятерки"}}, 
				{{"18","раз по"},{"10","сек с дисперсией"},{"0"},{"текст дела","->4,4,7,8"}},     //катание 3 мин 
				{{"1","раз по"},{"3", "сек с дисперсией"},{"0"},{"текст дела","Смена. Броски"}},
				{{"1","раз по"},{"15", "сек с дисперсией"},{"0"},{"текст дела",""}},
				{{"20","раз по"},{"9","сек с дисперсией"},{"0"},{"текст дела","->15,14,5,6"}},    //броски 3 мин

				{{"1","раз по"},{"5", "сек с дисперсией"},{"0"},{"текст дела","Смена.Катание"}}, 
				{{"18","раз по"},{"10","сек с дисперсией"},{"0"},{"текст дела","->4,4,16,17"}},     //катание 3 мин (16 скорость 17 бросок)
				{{"1","раз по"},{"3", "сек с дисперсией"},{"0"},{"текст дела","Смена. Броски"}},
				{{"1","раз по"},{"15", "сек с дисперсией"},{"0"},{"текст дела",""}},
				{{"20","раз по"},{"9","сек с дисперсией"},{"0"},{"текст дела","->15,14,5,6"}},    //броски 3 мин

				{{"1","раз по"},{"5", "сек с дисперсией"},{"0"},{"текст дела","Смена.Катание"}}, 
				{{"18","раз по"},{"10","сек с дисперсией"},{"0"},{"текст дела","->4,4,24,25"}},     //катание 3 мин (24 маневр 25 пас)
				{{"1","раз по"},{"3", "сек с дисперсией"},{"0"},{"текст дела","Смена. Броски"}},
				{{"1","раз по"},{"15", "сек с дисперсией"},{"0"},{"текст дела",""}},
				{{"20","раз по"},{"9","сек с дисперсией"},{"0"},{"текст дела","->15,14,5,6"}},    //броски 3 мин

				{{"1","раз по"},{"3", "сек с дисперсией"},{"0"},{"текст дела","Период завершен."}}, 
...

	    {
			...
			{   
				//{{"1500"},{"прошлосек+1"},{"0"},{"1"}},
				{{"1500"},{"(250+ 120*sin(3.14*полноевремя(0)/1000))/(2*3*60)"},{"0"},{"текст дела","->1"}},
			}
	    ...
	    //===========дых 1 =====
		{
			...
			{   
				...
				{{"1"},{"6"},{"0"},{"текст дела",""}},
				{{"1500"},{"(290+ 140*sin(3.14*полноевремя(0)/1000))/(2*3*60)"},{"0"},{"текст дела","->1"}},
	    ...
	    //===========дых 1 =====
	    {
			...
			{   
				//{{"1500"},{"прошлосек+1"},{"0"},{"1"}},
				{{"1500"},{"(220+ 120*sin(3.14*полноевремя(0)/780))/(2*3*60)"},{"0"},{"текст дела","->1"}},
			}
		...
		//===========дых 2 =====
	    {
			...
			{},{},{},{},{},{},{}, //резерв
			{   
				{{"1500"},{"(200+ 120*sin(3.14*полноевремя(0)/580))/(2*3*60)"},{"0"},{"текст дела","->1"}},
			}
		},
		
		//===========бег 180+- =====
	    {
			{{{"name","бег (180+ 20*sin(3.14*номеритерации1/10))"} ,{"id","тест_бег_ур1"} }},
			{{{"disabled","0"}}},
			{{{"tags","дых#бег#"}}},
			{},{},{},{},{},{},{}, //резерв
			{   
				//{{"5500"},{" (180+"},{"0"},{"1"}},
				{{"5500"},{" (180+ 20*sin(3.14*полноевремя(0)/500))/(2*3*60)"},{"0"},{"текст дела","->3"}},
			}
		},
		//=====================
	...
	/*
	 ...
	 {°°,}°°,
	 {°°,}°°,
	 {°°,{°,{•,《1》,}•,{•,《4》,}•,{•,《0》,}•,{•,《текст дела》,《разминка амосова》,}•,}°,{°,{•,《1》,}•,{•,《7》,}•,{•,《0》,}•,{•,《текст дела》,《》,}•,}°,{°,{•,《20》,}•,{•,《(200+ 50*номеритерации1)/1000》,}•,{•,《0》,}•,{•,《текст дела》,《а》,}•,}°,}°°,
	 }°°°,
	*/
